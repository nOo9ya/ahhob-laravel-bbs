...
@section('title', '홈')
@section('description', 'Ahhob 커뮤니티에 오신 것을 환영합니다! 다양한 주제의 게시판에서 소통하고, 쇼핑몰에서 안전하게 쇼핑하세요.')
@section('keywords', '커뮤니티, 게시판, 쇼핑몰, 소통, 정보공유, 포인트시스템, ahhob')
@section('og_type', 'website')
@section('og_title', 'Ahhob - 함께 소통하고 성장하는 커뮤니티')

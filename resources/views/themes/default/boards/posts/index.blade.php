...
@section('description', $board->description ?: $board->name . ' 게시판입니다. 다양한 정보를 공유하고 소통하세요.')
@section('keywords', $board->name . ', 게시판, 커뮤니티, 정보공유')
@section('og_type', 'website')
@section('og_title', $board->name . ' - Ahhob')
@section('canonical', route('boards.posts.index', $board->slug))

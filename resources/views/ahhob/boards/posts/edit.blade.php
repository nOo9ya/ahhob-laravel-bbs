<x-ahhob.layouts.app title="게시글 수정">
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="bg-white shadow-sm border-b border-gray-200">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('boards.posts.show', [$board->slug, $post->id]) }}" class="text-gray-500 hover:text-gray-700 text-sm">{{ Str::limit($post->title, 20) }}</a>
                            </div>
                        </li>
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="text-gray-700 text-sm font-medium">수정</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">게시글 수정</h1>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <form method="POST" action="{{ route('boards.posts.update', [$board->slug, $post->id]) }}" enctype="multipart/form-data" id="post-form">
                @csrf
                @method('PUT')
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        @if($post->attachments && $post->attachments->count() > 0)
                            <div>
                                ...
                                <div class="space-y-2" id="existing-files">
                                    @foreach($post->attachments as $attachment)
                                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-200" data-attachment-id="{{ $attachment->id }}">
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="text-xs text-gray-500">{{ $attachment->human_file_size }}</div>
                                                </div>
                                            </div>
                                            <div class="flex items-center space-x-2">
                                                ...
                                                <button type="button" 
                                                        onclick="removeExistingFile({{ $attachment->id }})" 
                        ...
                        <!-- 새 첨부파일 -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">새 첨부파일 추가</label>
                ...
                <!-- 삭제할 기존 첨부파일 ID 목록 -->
                <input type="hidden" name="removed_attachments" id="removed-attachments" value="">
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        function removeExistingFile(attachmentId) {
            if (confirm('이 파일을 삭제하시겠습니까?')) {
                ...
                fileElement.querySelector('button').innerHTML = '삭제됨';
